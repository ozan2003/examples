...
**				    ÖDEV NUMARASI: 1
**				    
**					ÖÐRENCÝ ADI: Ozan Malcý
**				    
**					ÖÐRENCÝ NUMARASI: B211210039
**				    
**					DERS GRUBU: C
****************************************************************************/
...
int main()
{
	...
	switch (secim)
	{
		...
		switch (menusecim)
		{
			...
			case 1: listeyazdir1(); goto L514; break;
			...
			case 4: printortalama4(); goto L514; break;
			

			case 5: printstandartsapma5(); goto L514; break;
			

			case 6: printikiaraliktannotsecmece6(student); goto L514; break;
			 

			case 7: printbirdegeraltinotsecmece7(student); goto L514; break;
			

			case 8: printbirdegerustunotsecmece8(student); goto L514; break;
