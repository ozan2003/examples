...
// Here, an array named "student" comprised of 100 members with the type of StructofStudent.
...
int main()
{
	...
	do
	{
		...
		switch (menuchoice)
		{
			...
			case 4: printmean(); break;


			case 5: print_standard_deviation(); break;


			case 6: print_grade_between_two_numbers(student); break;


			case 7: print_grade_lower_than_given_value(student); break;


			case 8: print_grade_greater_than_given_value(student); break;
