...
void printlist()
{
	...
	for (int i = 0; i < 100; i++)
	{
		...
		cout << "\nName: " << student[i].name << "\n";
		cout << "Surname: " << student[i].surname << "\n";
		cout << "ID: " << student[i].id << "\n";

		cout << "Date of Birth: " << student[i].birthdate.day << "." << student[i].birthdate.month << "." 
															          << student[i].birthdate.year << " (D/M/Y)" << "\n";

		cout << "1st Quiz Grade: " << student[i].quiz1;
		cout << " ("; print_numerical_to_letter_grade(student[i].quiz1); cout << ")\n";
		
		cout << "2nd Quiz Grade: " << student[i].quiz2;
		cout << " ("; print_numerical_to_letter_grade(student[i].quiz2); cout << ")\n";

		cout << "1st Assignment Grade: " << student[i].assignment1;
		cout << " ("; print_numerical_to_letter_grade(student[i].assignment1); cout << ")\n";

		cout << "2nd Assignment Grade: " << student[i].assignment2;
		cout << " ("; print_numerical_to_letter_grade(student[i].assignment2); cout << ")\n";

		cout << "Project Grade: " << student[i].project;
		cout << " ("; print_numerical_to_letter_grade(student[i].project); cout << ")\n";

		cout << "Midterm Grade: " << student[i].midterm;
		cout << " ("; print_numerical_to_letter_grade(student[i].midterm); cout << ")\n";

		cout << "The Final Grade: " << student[i].final;
		cout << " ("; print_numerical_to_letter_grade(student[i].final); cout << ")\n";

		
		cout << "Mid-year Grade: " << student[i].midyeargrade;
		cout << " ("; print_numerical_to_letter_grade(student[i].midyeargrade); cout << ")\n";
		
		cout << "Semester Grade: " << student[i].semestergrade;
		cout << " ("; print_numerical_to_letter_grade(student[i].semestergrade); cout << ")\n\n\n";

		if (((i+1) % 20 == 0) && (i != 0) && ((i+1) != 100))
		{
			cout << "The first 20 students are printed. Press any key to print the next 20. ";
...
void print_grade_between_two_numbers(StructofStudent student[100])
{
	...
	{
		cout << "The numbers are equal... Please enter again: ";

		cin >> low >> high;
	}
	else if (!(((0 <= low && low <= 100)) && ((0 <= high && high <= 100))))
	{
		cout << "The numbers are outside of the desired interval... Please enter again: ";
...
int main()
{
	...
	L369:
	cout << "To enter students at random, press 1.\n";
	cout << "To manually enter students, press 2. ";
	...
	switch (choice)
	{
		...
		case 2:
		{
			...
			for (int i = 0; i < 100; i++)
			{
				...
				cout << "Enter the student #" << i + 1 << "'s surname: ";
				cin >> student[i].surname;
				

				cout << "Enter the student #" << i + 1 << "'s ID Number: ";
				cin >> student[i].id;

				cout << "Enter the student #" << i + 1 << "'s day, month and year of birth respectively: ";
				cin >> student[i].birthdate.day >> student[i].birthdate.month >> student[i].birthdate.year;
				

				cout << "Enter the student #" << i + 1 << "'s 1st quiz grade: ";
				gradecheck(student[i].quiz1);
				

				cout << "Enter the student #" << i + 1 << "'s 2nd quiz grade: ";
				gradecheck(student[i].quiz2);
				

				cout << "Enter the student #" << i + 1 << "'s 1st assignment grade: ";
				gradecheck(student[i].assignment1);
				

				cout << "Enter the student #" << i + 1 << "'s 2nd assignment grade: ";
				gradecheck(student[i].assignment2);
				

				cout << "Enter the student #" << i + 1 << "'s midterm grade: ";
				gradecheck(student[i].midterm);
				

				cout << "Enter the student #" << i + 1 << "'s final grade: ";
		...
		L497:
		cout << "*************************************************************************************\n"
			    "To print the list of students, press 1.\n"
				"To print the highest grade in the class, press 2.\n"
				"To print the lowest grade in the class, press 3.\n"
		...
		switch (menuchoice)
		{
			...
			case 1: printlist(); goto L497; break;
